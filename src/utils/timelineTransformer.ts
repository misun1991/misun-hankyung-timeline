...
export function mapSectionToCategory(section?: string): CategoryType {
...
export function getMonthsDifference(d1: string, d2: string): number {
  try {
...
export function transformRawItemsToClusters(rawItems: any[]): ClusterTopic[] {
